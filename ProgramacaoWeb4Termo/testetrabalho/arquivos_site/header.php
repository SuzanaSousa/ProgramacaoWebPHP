...
<body >
    ...
    <nav class="navbar  navbar-expand-lg fixed-top " style="      background-color:#ddddd1; z-index: 1000;">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item fw-bolder" href="cardapio.php#bebidas">Bebidas</a></li>
